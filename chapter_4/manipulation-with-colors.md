...
Эта функция, в отличие от предыдущих, не имеет пары и на ее использование накладываются некоторые ограничения.
...
Если не углубляться в вычисление значений красного, зеленого и синего, то показать правильность работы этой функции можно на основе расчета значения прозрачности:
...
Функция **Hard light (Жесткий свет)** работает так же, как и функция **Overlay**. Разница лишь в том, что передаваемые параметры меняются местами при вызове функции **Overlay**.
